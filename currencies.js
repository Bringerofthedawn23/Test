/**
 * Currency metadata: ISO 4217 code -> { name, symbol }.
 * Used to render friendly labels in the dropdowns. The set of currencies the
 * app actually offers is driven by what the live rates API returns, so any
 * code missing here still works — it just shows the raw code as its label.
 */
window.CURRENCIES = {
